...
DO $$
DECLARE
  v_user_id UUID := '60b5a8e6-4700-4143-b0ec-4f445ee04d61'::UUID;
  v_email TEXT := 'francesca.tabor.ai@gmail.com';
...
('00000000-0000-0000-0000-000000001700'::UUID, 'Global Bakery AI Transformation Workspace', '60b5a8e6-4700-4143-b0ec-4f445ee04d61'::UUID)
...
VALUES (
  ...
  '60b5a8e6-4700-4143-b0ec-4f445ee04d61'::UUID,
  'Owner'
)
...
-- ============================================================
-- 1. User Setup:
--    - User: Francesca Tabor (francesca.tabor.ai@gmail.com)
--    - User UID: 60b5a8e6-4700-4143-b0ec-4f445ee04d61
--    - All projects and workspaces are assigned to this user
--
-- 2. Data Structure:
